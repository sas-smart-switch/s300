...
MICROSEMI_BEGIN( )
#include "../../../board/mv_ebu/common/galileo/emic.h"
MICROSEMI_END( )
#include "../../../board/mv_ebu/common/galileo/ecc_galileo.h"
...
#endif
MICROSEMI_BEGIN( )
   GetSendSwitchExpanderInfo();
MICROSEMI_END( )
   printf("ECC error detection Summary:\n");
   SBE_output();
   DBE_output();
