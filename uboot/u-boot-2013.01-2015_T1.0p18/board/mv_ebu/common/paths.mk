...
# MICROSEMI_BEGIN( )
GALILEO_DIR        = $(AXP_CMN_DIR)/galileo
# MICROSEMI_END( )
# HAL components
...
# MICROSEMI_BEGIN( )
# Galileo include path
GALILEO_INC_PATH  = -I$(GALILEO_DIR) -I$(GALILEO_DIR)/flashromlayout/inc -I$(GALILEO_DIR)/compositeimage/inc -I$(GALILEO_DIR)/compositeimage/inc/shared
 
# Compiler and linker flags
CFLAGS   += $(MV_DEFINE) $(OSSERVICES_PATH) -I$(TOPDIR) $(HAL_PATH) $(COMMON_PATH) \
            $(USP_PATH) $(SOC_PATH) $(BOARD_PATH) $(SYS_PATH) $(GALILEO_INC_PATH)
# MICROSEMI_END( )
CPPFLAGS += $(CFLAGS)
