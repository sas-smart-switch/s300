...
#define DRIVER_VERSION		"1.1.3-542"
#define DRIVER_MAJOR		1
#define DRIVER_MINOR		1
#define DRIVER_RELEASE		3
#define DRIVER_REVISION		542
...
#if TORTUGA
	if (iocommand.Request.Timeout > 255)
		request.reserved2 = 255;
	else
		request.reserved2 = (u8)iocommand.Request.Timeout;
#endif
